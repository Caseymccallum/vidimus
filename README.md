...
[![Vectors](https://img.shields.io/badge/vectors-49-3DA639)](spec/vectors/receipt-vectors.json)
...
> browser extension: 165 tests, 49 conformance vectors, no dependencies. The format is checkable and is
...
- 49 conformance vectors, rebuilt and re-hashed on every run;
...
- **A second implementation — started.** `conformance/` is a Python implementation of all 21 checks of section
  ...
  of 49 fixtures, corroborates 3 refusals, and disagrees on none — and it rolls the checks up into `levels`,
  ...
  11.1 says a conforming run need not — a caveat is prose about what was *not* established
  (D-036, `conformance/README.md`). The fixtures ship for anyone extending it:
