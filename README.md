...
[![Vectors](https://img.shields.io/badge/vectors-61-3DA639)](spec/vectors/receipt-vectors.json)
...
> browser extension: 165 tests, 61 conformance vectors, no dependencies. The format is checkable and is
...
- 61 conformance vectors, rebuilt and re-hashed on every run;
